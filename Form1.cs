...
namespace Project3_EntityFrameworkStatistics
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            lblPrdoductAveragePrice.Text = averageProductPrice.ToString() + " ₺";
            ...
            var totalPriceByProductNameIsGazozPrice = db.TblProduct.Where(x=> x.ProductName == "Gazoz").Select(y=> y.ProductPrice).FirstOrDefault();
            var totalPriceByProductNameIsGazoz = totalPriceByProductNameIsGazozGetStock * totalPriceByProductNameIsGazozPrice;
            lblTotalPriceByProductNameIsGazoz.Text = totalPriceByProductNameIsGazoz.ToString() + " ₺";

            //Stok sayısı 100'den az olan ürün sayısı
            var productCountByStockCountLessThen100 = db.TblProduct.Where(x => x.ProductStock < 100).Count();
            lblProductStockLessThen100.Text = productCountByStockCountLessThen100.ToString();
            ...
            lblOrderTotalPriceByCatgoryIsMeyve.Text = orderTotalPriceByCategoryIsMeyve.ToString() + " ₺";
            ...
            lblOrderTotalPriceByCatgoryIsMeyveByEf.Text = orderTotalPriceByCategoryIsMeyveWithEf.ToString() + " ₺";
